...
<template>
  <div id="giveRecord">
      <div class="bodyMainRow">
          <span class="listTypeLon">获赠人</span>
          <span class="listTimeLon">赠送时间</span>
      ...
      <div class="bodyMainListBox" v-for="data in Data" :key="data.key">
          <div class="bodyMainRow">
              <span class="listTypeLon global_txtOver">{{data.give_member_username}}</span>
...
mounted: function mounted() {
  ...
  var _this = this;
  this.ajax(_this.port.giveRecord, {}, 'GET', function(res) {
    // console.log(res);
    if (res.code == 1) {
        _this.Data = res.data
    } else if (res.code == 0) {
